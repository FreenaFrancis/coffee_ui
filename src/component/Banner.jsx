...
<div className='flex flex-col justify-center gap-6 sm:pt-0'>
    ...
    className='text-3xl sm:text-4xl font-bold font-cursive'>
        ...
        '>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores itaque architecto sint odit alias! Vel nihil officia perferendis earum et.
        </p>
...
<span>cold coffe</span>
            ...
            className=' border-l-4 border-primary/50 pl-6 space-y-3'>
                ...
                <p className='text-gray-500 text-sm'>
                    {""}
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore doloribus animi beatae mollitia iste ullam!
                </p>
            </div>
        </div>
